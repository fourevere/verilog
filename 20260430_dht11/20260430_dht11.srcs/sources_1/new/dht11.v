...
module dht11_controller (
    ...
    output       valid,        //for check sum, valid가 1이면 led on
    inout        dht11
);

    parameter IDLE = 0, START = 1, WAIT = 2, SYNCL = 3, SYNCH = 4;
    parameter DATA_SYNC = 5, DATA_COUNT = 6, DATA_DECISION = 7, STOP = 8;
    ...
    always @(*) begin
        ...
        case (c_state)
            ...
            DATA_DECISION: begin
                ...
                //data_reg = {data_reg[39:0], bit_cnt_reg};
                //data_reg = (tick_cnt_reg > 45) ? {data_reg[39:0], bit_cnt_reg} : 0;
